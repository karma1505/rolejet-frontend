...
const sectionVariants = {
  ...
  visible: (i: number) => ({
    opacity: 1,
    y: 0,
    transition: { duration: 0.45, delay: i * 0.08, ease: [0.2, 0.65, 0.3, 0.9] },
  }),
};
            ...
            <div className="flex items-end justify-between mb-3">
              <div>
                <div className="flex items-baseline gap-1.5">
                  ...
                  <span className="text-sm text-text-tertiary font-sans">/ 100 credits</span>
                </div>
                <p className="text-xs text-text-secondary font-sans mt-0.5">Resets on the 1st of every month</p>
              </div>
              <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono-display font-bold">
                RJ
              </span>
            </div>
          ...
          <SectionCard index={2}>
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between py-3 border-b border-border">
                <div>
                  <p className="text-sm font-sans font-medium text-text-primary">User ID</p>
                  <p className="text-xs text-text-tertiary font-mono-data mt-0.5 truncate max-w-xs">{user.id}</p>
                </div>
              </div>
              <div className="flex items-center justify-between py-3 border-b border-border">
                <div>
          ...
          <SectionCard index={3}>
            ...
            <div className="rounded-xl border border-danger/20 bg-danger/5 p-4">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-sm font-sans font-semibold text-text-primary">Delete Account</p>
